...
//    fun addFile(@Path("userId") userId: Int, @Body addFile: AddFile): Call<Void> //Call<Void>
    ...
    @GET("/api/marksForUserAverage/userId={userId}/kindOfMarkId={kindOfMarkId}")
    fun marksForUserAverage(@Path("userId") userId: Int, @Path("kindOfMarkId") kindOfMarkId: Int): Call<List<MarkAverage>>
