module.exports = (app) => {
    ...
    app.get('/api/marksForUserAverageByDateWithParam/userId=:userId/kindOfMarkId=:kindOfMarkId/date1=:date1/date2=:date2/myparam=:myparam', mark_value.MarksWithAverageByDateWithParametrs);
